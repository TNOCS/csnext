...
const config = [
    buildConfig({ cs: ['velocityjs', 'hammerjs', "./src/index.ts",] }, { 'cs-client': 'cs-client', 'cs-core': 'cs-core', '@csnext/cs-core':'@csnext/cs-core','@csnext/cs-client': '@csnext/cs-client', 'vue': 'Vue', 'Vue': 'Vue' })
