...
*Defined in [cs-map/src/classes/layer-service-options.ts:8](https://github.com/RichardHovenkamp/csnext/blob/6deb7f51/packages/cs-map/src/classes/layer-service-options.ts#L8)*
...
*Defined in [cs-map/src/classes/layer-service-options.ts:7](https://github.com/RichardHovenkamp/csnext/blob/6deb7f51/packages/cs-map/src/classes/layer-service-options.ts#L7)*
