<template>
  <div style="height: 100%; padding: 5px" v-if="isrd">
    <v-data-table :headers="headers" :search="search" :items="isrd.graph" item-key="id" class="elevation-1">
      <template v-slot:top>
        <v-toolbar flat>
...
export default class EntityManagement extends WidgetBase {
  public search = "";
  public headers = [
    {
      text: "id",
